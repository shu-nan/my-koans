...
# => "It was the best of times,\nIt was the worst of times.\n"
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # 
    # -- Notes -- : http://stackoverflow.com/questions/4684446/why-is-the-shovel-operator-preferred-over-plus-equals-when-building-a
  ...
  def test_single_quotes_sometimes_interpret_escape_characters
    ...
    assert_equal 2, string.size
    assert_equal "\\'", string
    # -- Notes -- : http://stackoverflow.com/questions/8554479/koans-ruby-escape-characters-confusion
    # if c is a character that doesn't need to be escaped within a double quoted string, then \c will be just c.
  end
